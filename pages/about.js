    ...
    <Box minHeight="100vh" display="flex" flexDirection="column" my={8}>
      ...
      <Box flexGrow={1} pb={8}>
        <Container maxWidth="lg">
          <Box my={4}>
          <Typography variant="h2" component="h1" align="center" gutterBottom style={{ fontFamily: "'Roboto Slab', serif", fontSize: '3rem', fontWeight: 'bold', color: '#3f51b5', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>
  About Us
</Typography>
            <Box my={4}>
